...
from __globals import current_app
import __json as json
...
class JSONMixin(object):
    ...
    def is_json(self):
        ...
        .. versionadded:: 0.11
        """
        mt = self.mimetype  # pylint: disable=invalid-name
        return (
            mt == 'application/json'
    ...
    def get_json(self, force=False, silent=False, cache=True):
        ...
        try:
            rv = json.loads(data)  # pylint: disable=invalid-name
            ...
            if silent:
                ...
                rv = self.on_json_loading_failed(  # pylint: disable=assignment-from-no-return,invalid-name
                    e)  # pylint: disable=invalid-name
                if cache:
    ...
    def on_json_loading_failed(self, e):  # pylint: disable=invalid-name
...
class Request(RequestBase, JSONMixin):
    ...
    def _load_form_data(self):
        ...
        if (
            ...
            from __debughelpers import attach_enctype_error_multidict  # pylint: disable=import-outside-toplevel
